...
//
//      Copyright:      InterSense 2009 - All rights Reserved.
//
...
typedef struct
{
    ...
    BYTE    CommIntegrity;      // Communication integrity (percentage of packets received from tracker, 0-255) 
...
// ISD_SetupRingBuffer accepts a pointer to the ring buffer, and its size.
